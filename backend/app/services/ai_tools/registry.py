...
def system_modules(db: Session, user: User, params: dict[str, Any]) -> dict[str, Any]:
    modules = [
        ...
        {"name": "日志解析", "domain": "parser", "capabilities": ["log_parsing", "alert_extraction"], "related_tools": ["log.raw_grep", "evidence.extract_ioc"]},
...
TOOL_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "ti.lookup_ip": {
        "domain": "threat_intel",
        "level": "L2",
        "description": "查询单个 IP 威胁情报",
        "capabilities": ["threat_intelligence_lookup"],
        "input_entities": ["ip"],
        "output_evidence_types": ["ip_reputation"],
        "reasoning_roles": ["fact_lookup"],
    ...
    "intel.ip_report": {
        "domain": "intelligence",
        "level": "L2",
        "description": "IP 全维度档案（资产+告警轨迹+情报+审计）",
        "capabilities": ["unified_entity_profile"],
        "input_entities": ["ip"],
        "output_evidence_types": ["ip_intel_report", "asset_profile", "alert_list", "ip_reputation", "audit_timeline", "tabular_dataset"],
