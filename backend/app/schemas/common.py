...
class DeviceCreate(BaseModel):
    ...
    product: str = ""
    version: str = ""
    device_role: str = "monitor"
    browser_assistant_enabled: bool = True
    browser_url_patterns: list[str] = Field(default_factory=lambda: ["http://*/*", "https://*/*"])
...
class DeviceUpdate(BaseModel):
    ...
    browser_assistant_enabled: bool | None = None
    browser_url_patterns: list[str] | None = None
...
class DeviceOut(OrmModel):
    ...
    version: str
    device_role: str
    browser_assistant_enabled: bool
    browser_url_patterns: list[str]
