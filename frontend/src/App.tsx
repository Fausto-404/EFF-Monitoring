...
import { Bell, Brain, Database, FileText, LayoutDashboard, ListChecks, LogOut, Settings, Table2, Users } from 'lucide-react';
...
type PageKey = 'dashboard' | 'alerts' | 'parser' | 'ai' | 'assets' | 'messages' | 'team' | 'rules' | 'templates' | 'ipLists' | 'settings';
      ...
      <Sider width={216} className="app-sider">
        ...
        <Menu
          ...
          items={[
            ...
            { key: 'parser', icon: <FileText size={17} />, label: '日志解析' },
            ...
            { type: 'divider' },
            { key: 'rules', icon: <ListChecks size={17} />, label: '规则中心' },
