...
const systemBuiltinRules: (Partial<ParseRule> & { category: string })[] = [
  ...
  { id: -50, name: '监测上报人员', field_key: 'reported_by_name', match_type: 'system', category: '流程协作', pattern: '创建或同步告警的上报人员', enabled: true },
  { id: -51, name: '研判结果', field_key: 'analysis_result', match_type: 'system', category: '流程协作', pattern: '研判阶段提交的处置建议结果', enabled: true },
  { id: -52, name: '是否应急', field_key: 'is_emergency', match_type: 'system', category: '流程协作', pattern: '是否被判定为应急处置', enabled: true },
  { id: -53, name: '封禁位置', field_key: 'block_device_names', match_type: 'system', category: '流程协作', pattern: '封禁类处置选择的封禁设备名称', enabled: true },
  { id: -54, name: '封禁时间', field_key: 'block_at', match_type: 'system', category: '流程协作', pattern: '封禁类处置完成时间', enabled: true },
  { id: -55, name: '处置描述', field_key: 'response_note', match_type: 'system', category: '流程协作', pattern: '应急处置完成时填写的描述', enabled: true },
  { id: -56, name: '应急人员', field_key: 'response_owner', match_type: 'system', category: '流程协作', pattern: '应急处置完成时选择的人员', enabled: true },
  ...
  { id: -11, name: '设备IP', field_key: 'current_device_ip', match_type: 'system', category: '设备信息', pattern: '安全设备的管理地址', enabled: true },
