...
import { InfoCircleOutlined, DeleteOutlined, SendOutlined, PlusOutlined, UserOutlined, RobotOutlined } from '@ant-design/icons';
...
function ChatCenter() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: showConversations ? '280px 1fr' : '1fr', gap: 16 }}>
      {showConversations && (
        <Card
          size="small"
          title="对话列表"
      ...
      >
        <Space direction="vertical" className="full-width">
          <div style={{ height: 500, overflow: 'auto', border: '1px solid #f0f0f0', padding: '16px', borderRadius: 4, background: '#fafafa' }}>
